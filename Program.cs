...
builder.Services.AddDbContext<ApiDbContext>(options =>
    options.UseSqlServer(@"Server=localhost;database=danjdb;user id=INTERNAL\JM4583104;password=;TrustServerCertificate=True;Integrated Security=True;Trusted_Connection=True", providerOptions => providerOptions.EnableRetryOnFailure())
);
